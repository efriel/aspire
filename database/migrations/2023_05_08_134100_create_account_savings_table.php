...
return new class extends Migration
{
    ...
    {
        Schema::create('account_savings', function (Blueprint $table) {
            $table->integer('account_number')->primary();
            $table->integer('account_type_id')->references('id')->on('master_savings');
    ...
    {
        Schema::dropIfExists('account_savings');
    }
};
